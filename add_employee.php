...
<head>
   ...
   <style>
    ...
    #progress-bar-container {
        width: 80%; /* Smaller width for the progress bar */
        height: 8px;
        background-color: #ddd;
        border-radius: 5px;
        margin: 4px auto 0; /* Center and add spacing above */
    }
    ...
    <div class="form-container">
        ...
        <form action="emp_insert.php" method="POST">
                              <div class="form-group row">
                                    <label for="ecode" class="col-sm-4 col-form-label"><b>Employee Code </b><span class="required" style="color: red; font-weight: bold;"> * </span></label>
                                    <div class="col-sm-8">
                                        <input type="text" name="ecode" data-required="1" value="<?php if(isset($ecode)){ echo $ecode;} ?>" id="ecode" placeholder="Enter Employee Code" class="form-control" readonly required/> 
                                        <strong class="required"><?php if(isset($errorecode)){ echo $errorecode;} ?> </strong>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label"><b>Gender:<span class="required" style="color: red; font-weight: bold;"> * </span></b></label>
